      ...
      <div className="row No-margin">
        {
          ...
          <div className="">
            ...
            <div className="col s12 m12 No-margin Feature-box No-padding Container-wrap-center-cross">
              ...
              <div className="col s12 m7 No-margin No-padding Container-wrap-center-cross">
                ...
                <div className="col s12 m12 Feature-text-box">
                  <div className="Feature-text">Our system is designed to ease your operational burden in managing your daily sales transactions from each service providers at your shop with friendly user interface.</div>
                </div>
              </div>
            </div>
            ...
            <div className="col s12 m12 No-margin Feature-box No-padding Container-wrap-center-cross">
              <div className="col s12 m7 Container-wrap-center-cross">
                <div className="col s12 m12 Feature-header-box">
                  <div className="Feature-header-text">Managerial Reports</div>
                </div>
                <div className="col s12 m12 Feature-text-box">
                  <div className="Feature-text">Our system is designed to view selected reports to gain insight of your shop's transactions and extract raw transactions data into Excel file for accounting purposes.</div>
                </div>
              </div>
              <div className="col s12 m4 No-margin No-padding Container-wrap-center">
                <ReportSvg height="10em" width="10em" />
              </div>
            </div>
            ...
            <div className="col s12 m12 No-margin Feature-box Feature-bottom-box No-padding Container-wrap-center-cross">
              ...
              <div className="col s12 m7 No-margin No-padding Container-wrap-center-cross">
                <div className="col s12 m12 Feature-header-box Container-wrap-center-cross">
          ...
          <div>
            ...
            <div className="col s12 m12 No-margin Feature-box Feature-bottom-box No-padding Container-wrap-center-cross">
              ...
              <div className="col s12 m7 Container-wrap-center-cross">
                <div className="col s12 m12 Feature-header-box Container-wrap-center">
                  <div className="Feature-header-text">Go Paperless</div>
                  <div className="Beta-text">BETA</div>
                </div>
                <div className="col s12 m12 Feature-text-box">
