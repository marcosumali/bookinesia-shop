  ...
  render() {
    return (
      <div className="col m12 No-margin No-padding Height-100cent">
        <div className="col m5 No-margin Height-100cent Manage-menu-box" style={{ paddingRight: '0px !important', overflowY: 'hidden' }}>
          <div className="col m12 No-margin Manage-content-card" style={{ paddingRight: "0px" }}>
            <ManageShop />
          </div>
        </div>
  
        <div className="col m7 No-margin Height-100cent Manage-menu-box" style={{ paddingRight: '0px !important', overflowY: 'hidden' }}>
